...
//creates a pool for PDF Adapter by loading next two and previous two pages of PDF when current page is being shown
class PdfBitmapPool(private val pdfRenderer: PdfRenderer, private val config: Bitmap.Config, private val densityDpi : Int) {
    ...
    fun loadPage(pageIndex: Int): Bitmap {
        Log.i(PdfBitmapPool::class.java.simpleName, "Loading page at index $pageIndex")
